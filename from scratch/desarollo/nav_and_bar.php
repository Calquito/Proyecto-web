...
<div class="sticky-top ">
  ...
  <div class="d-flex flex-row bd-highlight mb- justify-content-around" style="background-color: #F2F4F9;">
    ...
    <div class="d-flex flex-row bd-highlight mb- justify-content-around w-50">
          ...
          <div class="p-2 bd-highlight">
            <button class="btn btn-link text-body" type="button" data-toggle="modal" data-target="#universidades_modal" >Universidad</button>
          </div>
          <div class="p-2 bd-highlight">
            <button class="btn btn-link text-body" type="button">TOP</button>
          </div>
    </div>
    <div class=" bd-highlight d-none d-sm-block w-25 "></div>
  </div>
  <div class="border-top "></div>
</div>